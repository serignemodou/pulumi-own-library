...
export declare class AccessPackageCatalogRoleAssignment extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessPackageCatalogRoleAssignmentState, opts?: pulumi.CustomResourceOptions): AccessPackageCatalogRoleAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is AccessPackageCatalogRoleAssignment;
    /**
