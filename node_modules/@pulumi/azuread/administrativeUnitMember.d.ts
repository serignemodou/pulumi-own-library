 ...
 * ```
 */
export declare class AdministrativeUnitMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AdministrativeUnitMemberState, opts?: pulumi.CustomResourceOptions): AdministrativeUnitMember;
    /**
     * Returns true if the given object is an instance of AdministrativeUnitMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AdministrativeUnitMember;
    /**
     * The object ID of the administrative unit you want to add the member to. Changing this forces a new resource to be created.
     */
    readonly administrativeUnitObjectId: pulumi.Output<string | undefined>;
    /**
