 ...
 * ```
 */
export declare class ApplicationFallbackPublicClient extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationFallbackPublicClientState, opts?: pulumi.CustomResourceOptions): ApplicationFallbackPublicClient;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationFallbackPublicClient;
    /**
