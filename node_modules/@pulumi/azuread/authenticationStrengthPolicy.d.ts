 ...
 * ```
 */
export declare class AuthenticationStrengthPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthenticationStrengthPolicyState, opts?: pulumi.CustomResourceOptions): AuthenticationStrengthPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AuthenticationStrengthPolicy;
    /**
     * List of allowed authentication methods for this authentication strength policy.
     */
    readonly allowedCombinations: pulumi.Output<string[]>;
    /**
