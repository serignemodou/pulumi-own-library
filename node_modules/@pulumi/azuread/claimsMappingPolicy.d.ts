 ...
 * ```
 */
export declare class ClaimsMappingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClaimsMappingPolicyState, opts?: pulumi.CustomResourceOptions): ClaimsMappingPolicy;
    /**
     * Returns true if the given object is an instance of ClaimsMappingPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClaimsMappingPolicy;
    /**
