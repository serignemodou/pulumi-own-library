...
function getClientConfig(opts) {
    ...
    return pulumi.runtime.invoke("azuread:index/getClientConfig:getClientConfig", {}, opts);
}
...
function getClientConfigOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azuread:index/getClientConfig:getClientConfig", {}, opts);
}
