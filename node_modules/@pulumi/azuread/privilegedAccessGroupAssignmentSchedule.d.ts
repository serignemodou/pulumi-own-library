 ...
 * ```
 */
export declare class PrivilegedAccessGroupAssignmentSchedule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivilegedAccessGroupAssignmentScheduleState, opts?: pulumi.CustomResourceOptions): PrivilegedAccessGroupAssignmentSchedule;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrivilegedAccessGroupAssignmentSchedule;
    /**
