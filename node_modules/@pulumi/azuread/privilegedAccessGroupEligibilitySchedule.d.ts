 ...
 * ```
 */
export declare class PrivilegedAccessGroupEligibilitySchedule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivilegedAccessGroupEligibilityScheduleState, opts?: pulumi.CustomResourceOptions): PrivilegedAccessGroupEligibilitySchedule;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrivilegedAccessGroupEligibilitySchedule;
    /**
     ...
     */
    readonly permanentAssignment: pulumi.Output<boolean>;
    /**
