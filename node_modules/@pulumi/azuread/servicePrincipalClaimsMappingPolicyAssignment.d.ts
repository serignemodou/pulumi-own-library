 ...
 * ```
 */
export declare class ServicePrincipalClaimsMappingPolicyAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicePrincipalClaimsMappingPolicyAssignmentState, opts?: pulumi.CustomResourceOptions): ServicePrincipalClaimsMappingPolicyAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServicePrincipalClaimsMappingPolicyAssignment;
    /**
     * The ID of the claims mapping policy to assign.
     */
    readonly claimsMappingPolicyId: pulumi.Output<string>;
    /**
