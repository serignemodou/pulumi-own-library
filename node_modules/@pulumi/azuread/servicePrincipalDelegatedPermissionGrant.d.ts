 ...
 * ```
 */
export declare class ServicePrincipalDelegatedPermissionGrant extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicePrincipalDelegatedPermissionGrantState, opts?: pulumi.CustomResourceOptions): ServicePrincipalDelegatedPermissionGrant;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServicePrincipalDelegatedPermissionGrant;
    /**
     * A set of claim values for delegated permission scopes which should be included in access tokens for the resource.
     */
    readonly claimValues: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly resourceServicePrincipalObjectId: pulumi.Output<string>;
    /**
     ...
     */
    readonly servicePrincipalObjectId: pulumi.Output<string>;
    /**
     ...
     */
    readonly userObjectId: pulumi.Output<string | undefined>;
    /**
