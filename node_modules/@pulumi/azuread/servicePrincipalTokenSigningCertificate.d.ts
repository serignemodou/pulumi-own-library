 ...
 */
export declare class ServicePrincipalTokenSigningCertificate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicePrincipalTokenSigningCertificateState, opts?: pulumi.CustomResourceOptions): ServicePrincipalTokenSigningCertificate;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServicePrincipalTokenSigningCertificate;
    /**
