...
export declare function generateSchema(providerName: string, version: string, description: string, components: Record<string, ComponentDefinition>, typeDefinitions: Record<string, TypeDefinition>, packageReferences: Record<string, string>, namespace?: string): PackageSpec;
